        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-transparant">
            ...
            <li class="navbar-nav ms-auto ms-md-8 me-3 me-lg-4">
                <div class="back">
                    ...
                    <span class="keterangan"><b>MELIHAT HKI</b></span>
                </div>
        ...
        <div class="content">
            ...
            <form action="#">
                ...
                <div class="input-box">
                    ...
                    <input type="text" name="judul" id="judulHki" oninput="autoDelete()" class="input-text" placeholder="Pemrograman Naive-Bayes" disabled value="{{$hki->judul}}"/>
                </div>
                <div class="input-box">
                    <span class="label">Status</span>
                    <input type="text" name="status" id="status" oninput="autoDelete()" class="input-text" placeholder="" disabled value="{{$hki->status}}" />
                </div>
                <div class="input-box">
                    <span class="label">Jenis</span>
                    <input type="text" name="jenis" id="status" oninput="autoDelete()" class="input-text" placeholder="" disabled value="{{$hki->jenis}}" />
                </div>
                <div class="input-box">
