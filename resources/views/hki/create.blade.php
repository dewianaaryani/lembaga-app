        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-transparant">
            ...
            <li class="navbar-nav ms-auto ms-md-8 me-3 me-lg-4">
                <div class="back">
                    ...
                    <span class="keterangan"><b>Membuat HKI</b></span>
                </div>
        ...
        <div class="content">
            ...
            <form action="{{route('hki.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="input-box">
                    ...
                    <input type="text" name="sertifikat_hki" id="judulHki" oninput="autoDelete()" class="input-text" placeholder="Pemrograman Naive-Bayes" required/>
                </div>
                <div class="input-box">
                    <span class="label">Judul HKI</span>
                    <input type="text" name="judul" id="judulHki" oninput="autoDelete()" class="input-text" placeholder="Pemrograman Naive-Bayes" required/>
                </div>
                <div class="input-box">
                    <span class="label">Status</span>
                    <input type="text" name="status" id="status" oninput="autoDelete()" class="input-text" placeholder="" required />
                </div>
                <div class="input-box">
                    <span class="label">Jenis</span>
                    <input type="text" name="jenis" id="status" oninput="autoDelete()" class="input-text" placeholder="" required />
                </div>
                <div class="input-box">
                    <span class="label">Lampiran</span>
                    <input type="file" name="lampiran" id="status" oninput="autoDelete()" class="input-text" placeholder="" required />
                </div>
