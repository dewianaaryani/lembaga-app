    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-transparant">
            ...
            <li class="navbar-nav ms-auto ms-md-8 me-3 me-lg-4">
                <div class="back">
                    ...
                    <span class="keterangan"><b>EDIT FORUM</b></span>
                </div>
        ...
        <div class="content">
            ...
            <form action="{{ route('forum.update', $forum->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="input-box">
                    ...
                    <input type="text" name="judul" id="judulMakalah" oninput="autoDelete()" class="input-text" placeholder="" value="{{$forum->judul}}" />
                </div>
                <div class="input-box">
                    <span class="label">Lampiran</span>
                    <input type="file" name="lampiran" id="judulMakalah" oninput="autoDelete()" class="input-text" placeholder="" value="{{$forum->judul}}" />
                    
                </div>
                <div class="input-box">
                    <span class="label">Nama Forum</span>
                    <input type="text" name="nama_forum" id="namaForum" class="input-text" oninput="autoDelete()" placeholder="" value="{{$forum->nama_forum}}" />
                </div>
                <div class="input-box">
                    <span class="label">Institusi Penyelenggara</span>
                    <input type="text" name="institusi_penyelenggara" id="institusiPenyelenggara" class="input-text" oninput="autoDelete()" placeholder="" value="{{$forum->institusi_penyelenggara}}" />
                </div>
                <div class="input-box">
                    <span class="label">Tanggal Awal</span>
                    <input type="date" name="waktu_pelaksanaan_awal" id="waktuAwal" class="input-text" oninput="autoDelete()" placeholder="" value="{{$forum->waktu_pelaksanaan_awal}}" />
                </div>
                <div class="input-box">
                    <span class="label">Tanggal Akhir</span>
                    <input type="date" name="waktu_pelaksanaan_akhir" id="waktuAkhir" class="input-text" oninput="autoDelete()" placeholder="" value="{{$forum->waktu_pelaksanaan_akhir}}" />
                </div>
                <div class="input-box">
                    <span class="label">Tempat</span>
                    <input type="text" name="tempat"  id="tempat" class="input-text" oninput="autoDelete()" placeholder="" value="{{$forum->tempat}}" />
                </div>
                <div class="input-box">
                    <span class="label">Status</span>
                    <input type="text" name="status"  id="tempat" class="input-text" oninput="autoDelete()" placeholder="Pemakalah/Invited/Keynote" value="{{$forum->Status}}" />
                </div>
        ...
        <script>
            ...
            document.getElementById("submit").addEventListener("click", function() {
                ...
                var judulMakalah = document.getElementById("judulMakalah").value;
                var lampiran = document.getElementById("lampiran").value;
                var namaForum = document.getElementById("namaForum").value;
                var institusiPenyelenggara = document.getElementById("institusiPenyelenggara").value;
                var tanggalAwal = document.getElementById("tanggalAwal").value;
                var tanggalAkhir = document.getElementById("tanggalAkhir").value;
                var tempat = document.getElementById("tempat").value;
                
                updateData(idPenelitian, judulMakalah, lampiran, namaForum, institusiPenyelenggara, tanggalAwal, tanggalAkhir, tempat);
                window.history.back();
            });

            function updateData(idPenelitian, judulMakalah, lampiran, namaForum, institusiPenyelenggara, tanggalAwal, tanggalAkhir, tempat) {
                console.log("Updating data...");
                console.log("ID Penelitian:", idPenelitian);
                console.log("Judul Makalah:", judulMakalah);
                console.log("Lampiran:", lampiran);
                console.log("Nama Forum:", namaForum);
                console.log("Institusi Penyelenggara:", institusiPenyelenggara);
