        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-transparant">
            ...
            <li class="navbar-nav ms-auto ms-md-8 me-3 me-lg-4">
                <div class="back">
                    ...
                    <span class="keterangan"><b>MEMBUAT FORUM</b></span>
                </div>
        ...
        <div class="content">
            ...
            <form action="{{route('forum.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="input-box">
                    ...
                    <input type="text" name="sertifikat_forum" id="idPenelitian" oninput="autoDelete()" class="input-text" placeholder="" required />
                </div>
                <div class="input-box">
                    <span class="label">Judul Makalah</span>
                    <input type="text" name="judul" id="judulMakalah" oninput="autoDelete()" class="input-text" placeholder="" required />
                </div>
                <div class="input-box">
                    <span class="label">Lampiran</span>
                    <input type="file" name="lampiran" id="lampiran" oninput="autoDelete()" class="input-text" placeholder="" required />
                </div>
                <div class="input-box">
                    <span class="label">Nama Forum</span>
                    <input type="text" name="nama_forum" id="namaForum" class="input-text" oninput="autoDelete()" placeholder="" required />
                </div>
                <div class="input-box">
                    <span class="label">Institusi Penyelenggara</span>
                    <input type="text" name="institusi_penyelenggara" id="institusiPenyelenggara" class="input-text" oninput="autoDelete()" placeholder="" required />
                </div>
                <div class="input-box">
                    <span class="label">Tanggal Awal</span>
                    <input type="date" name="waktu_pelaksanaan_awal" id="waktuAwal" class="input-text" oninput="autoDelete()" placeholder="" required />
                </div>
                <div class="input-box">
                    <span class="label">Tanggal Akhir</span>
                    <input type="date" name="waktu_pelaksanaan_akhir" id="waktuAkhir" class="input-text" oninput="autoDelete()" placeholder="" required />
                </div>
                <div class="input-box">
                    <span class="label">Tempat</span>
                    <input type="text" name="tempat"  id="tempat" class="input-text" oninput="autoDelete()" placeholder="" required />
                </div>
                <div class="input-box">
                    <span class="label">Status</span>
                    <input type="text" name="status"  id="tempat" class="input-text" oninput="autoDelete()" placeholder="Pemakalah/Invited/Keynote" required />
                </div>
