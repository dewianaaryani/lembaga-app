    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-transparant">
            ...
            <li class="navbar-nav ms-auto ms-md-8 me-3 me-lg-4">
                <div class="back">
                    <a href="{{route('buku-ajar-teks.index')}}"><i class="bi bi-chevron-left"></i></a>
                    <span class="keterangan"><b>EDIT AJARTEXT</b></span>
                </div>
        ...
        <div class="content">
            ...
            <div class="form-box">
            <form action="{{ route('buku-ajar-teks.update', $bukuAjarTeks->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="input-box">
                    ...
                    <input type="idPeneliti" id="inputText" oninput="autoDelete()" class="input-text" placeholder=""  name="id_penelitian" value={{$bukuAjarTeks->penelitian->judul}} />
                </div>
                <div class="input-box">
                    <span class="label">Sertifikat Buku Ajar</span>
                    <input type="text" id="judulMakalah" oninput="autoDelete()" class="input-text" name="sertifikat_buku_ajar" placeholder=""  value={{$bukuAjarTeks->sertifikat_buku_ajar}} />
                </div>
                <div class="input-box">
                    <span class="label">Penerbit</span>
                    <input type="text" id="judulMakalah" oninput="autoDelete()" class="input-text" name="penerbit" placeholder=""  value={{$bukuAjarTeks->penerbit}} />
                </div>
                
                <div class="input-box">
                    <span class="label">Judul</span>
                    <input type="text" id="namaForum" name="judul" class="input-text" oninput="autoDelete()" placeholder=""  value={{$bukuAjarTeks->judul}} />
                </div>
                <div class="input-box">
                    <span class="label">ISBN</span>
                    <input type="text" id="institusiPenyelenggara" name="isbn" class="input-text" oninput="autoDelete()" placeholder=""  value={{$bukuAjarTeks->isbn}} />
                </div>
                <div class="input-box">
                    <span class="label">Jumlah Halaman</span>
                    <input type="numeric" id="tanggalAwal" name="jumlah_halaman" class="input-text" oninput="autoDelete()" placeholder=""  value={{$bukuAjarTeks->jumlah_halaman}} />
                </div>
                <div class="input-box">
                    <span class="label">Lampiran</span>
                    <input type="file" id="tanggalAwal" name="lampiran" class="input-text" oninput="autoDelete()" placeholder=""  value={{$bukuAjarTeks->jumlah_halaman}} />
                </div>
        ...
        <script>
            ...
            document.getElementById("submit").addEventListener("click", function() {
                var idPeneliti = document.getElementById("idPeneliti").value;
                var judulBuku = document.getElementById("judulBuku").value;
                var status = document.getElementById("status").value;
                var jenis = document.getElementById("jenis").value;
                
                updateData(idPenelitian, judulBuku, status, jenis);
                window.history.back();
            });

            function updateData(idPeneliti, judulBuku, status, jenis) {
                console.log("Updating data...");
                console.log("ID Peneliti:", idPeneliti);
