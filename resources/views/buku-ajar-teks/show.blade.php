    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-transparant">
            ...
            <li class="navbar-nav ms-auto ms-md-8 me-3 me-lg-4">
                <div class="back">
                    <a href="ajartext.php"><i class="bi bi-chevron-left"></i></a>
                    <span class="keterangan"><b>MELIHAT AJARTEXT</b></span>
                </div>
        ...
        <div class="content">
            ...
            <form action="#">
                <div class="input-box">
                    ...
                    <input type="idPeneliti" id="inputText" oninput="autoDelete()" class="input-text" placeholder="" disabled value={{$bukuAjarTeks->penelitian->judul}} />
                </div>
                <div class="input-box">
                    <span class="label">Sertifikat Buku Ajar</span>
                    <input type="text" id="judulMakalah" oninput="autoDelete()" class="input-text" name="sertifikat_buku_ajar" placeholder="" disabled value={{$bukuAjarTeks->sertifikat_buku_ajar}} />
                </div>
                <div class="input-box">
                    <span class="label">Penerbit</span>
                    <input type="text" id="judulMakalah" oninput="autoDelete()" class="input-text" name="penerbit" placeholder="" disabled value={{$bukuAjarTeks->penerbit}} />
                </div>
                
                <div class="input-box">
                    <span class="label">Judul</span>
                    <input type="text" id="namaForum" name="judul" class="input-text" oninput="autoDelete()" placeholder="" disabled value={{$bukuAjarTeks->judul}} />
                </div>
                <div class="input-box">
                    <span class="label">ISBN</span>
                    <input type="text" id="institusiPenyelenggara" name="isbn" class="input-text" oninput="autoDelete()" placeholder="" disabled value={{$bukuAjarTeks->isbn}} />
                </div>
                <div class="input-box">
                    <span class="label">Jumlah Halaman</span>
                    <input type="numeric" id="tanggalAwal" name="jumlah_halaman" class="input-text" oninput="autoDelete()" placeholder="" disabled value={{$bukuAjarTeks->jumlah_halaman}} />
                </div>
                <div class="input-box">
                    <span class="label">Lampiran</span>
                    @if ($bukuAjarTeks->lampiran)
                        <a href="{{ asset('storage/public/' . $bukuAjarTeks->lampiran) }}" download class="btn">Download</a>
                    @endif
                </div>
